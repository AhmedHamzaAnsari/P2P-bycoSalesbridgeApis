...
function smtp_mailer($to, $time, $dealer_name, $dealer_id, $task_id, $db)
{
    ...
    $mail->Body = '<h3>Dear Team,<br>Following is the Retailer Profitability Audit Report attached in PDF Format for your review and action <br>Regards,</h3>'; //An HTML or plain text message body

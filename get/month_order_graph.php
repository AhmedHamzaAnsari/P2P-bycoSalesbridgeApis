...
if ($pass != '') {
    ...
    if ($pass == $access_key) {
        ...
        foreach ($allMonths as $month) {
            ...
            $sql = "SELECT dp.*,ap.name as product_name FROM dealers_products as dp
            join all_products as ap on ap.id=dp.name where dp.dealer_id=$dealer_id";
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                $get_orders = "SELECT count(*) as order_count FROM order_detail where cus_id=$dealer_id and product_type=$name and MONTH(date) = $month_series and  YEAR(date) = YEAR(CURRENT_DATE)";
                // echo $get_orders .'<br>';
                ...
                while ($row_2 = $result_orders->fetch_assoc()) {
                    ...
                    $productType = $product_name; // Replace this with your actual data source

...
if ($pass != '') {
    ...
    if ($pass == $access_key) {
        $sql_query1 = "SELECT uo.*,ut.type,geo.name as consignee_name,geo.sap_no code,
        (SELECT  CASE
        ...
        left join dealers as geo on geo.id = uo.userid where uo.userid='$dealer_id'and uo.type_id!='null' order by uo.id desc;";

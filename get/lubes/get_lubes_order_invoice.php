...
if ($pass != '') {
    if ($pass == $access_key) {
        ...
        $sql = "SELECT om.*,dl.name as dealer_name,dl.email,dl.location,dl.contact FROM bycobridge.lubes_order_main as om 
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $get_orders = "SELECT os.*,pc.name as category,ps.name as size_name,ps.ctn_size,ps.ctn_qty,(os.price*os.qty) as amount,pp.name as product_name,pp.code as product_code FROM bycobridge.lubes_order_sub as os

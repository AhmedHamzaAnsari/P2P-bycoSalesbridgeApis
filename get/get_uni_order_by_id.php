...
if ($pass != '') {
    if ($pass == $access_key) {
        ...
        $sql_query1 = "SELECT uo.*,ut.type,geo.name as consignee_name,geo.sap_no as code,vv.name as vendor_name,geo.email as d_email,geo.contact as d_contact,vv.email as v_email,vv.owner_name as v_owner_name,vv.contact as v_contact,vv.manager as v_manager,vv.manager_contact,vv.acount_no,vv.bank_name,vv.acount_title,vv.location as v_location,
        (SELECT  CASE
        ...
        where uo.type_id!='null' and uo.id='$id'  order by uo.id desc";

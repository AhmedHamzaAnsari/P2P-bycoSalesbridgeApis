                ...
                foreach ($item as $key => $values) {
                    ...
                    foreach ($values as $innerKey => $innerValues) {
                        ...
                        foreach ($innerValues as $innerInnerKey => $innerInnerValue) {
                            ...
                            $sql_check = "SELECT * FROM survey_category_questions where category_id='$category_id' and id='$question_id' and dpt!='' order by id desc";
                            ...
                            if ($count_check > 0) {
                                ...
                                if (mysqli_query($db, $sql1)) {
                                    ...
                                    foreach ($myArray as $value) {
                                        // echo $value . "<br>";
                                        $folow_ups = "INSERT INTO `bycobridge`.`follow_ups`
                                        (`category_id`,
                                        `question_id`,
                                        `answer`,
                                        `form_id`,

...
if (isset($_POST)) {
    ...
    echo $output;
    send_email($user_id, $dealer_id, $task_id);
...
function send_email($tm_id, $dealer_id, $task_id)
{
    ...
    curl_setopt_array(
        $curl,
        array(
            CURLOPT_URL => 'http://151.106.17.246:8080/bycobridgeApis/emailer/profitibilty_emailer.php?dealer_id=' . $dealer_id . '&task_id=' . $task_id . '&tm_id=' . $tm_id . '',
